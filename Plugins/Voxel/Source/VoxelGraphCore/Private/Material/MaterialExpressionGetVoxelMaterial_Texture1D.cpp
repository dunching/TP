...
#include "Material/MaterialExpressionGetVoxelMaterial_Texture1D.h"
...
void UMaterialExpressionGetVoxelMaterial_Texture1D::UpdateVoxelParameterData(
	...
	TVoxelInstancedStruct<FVoxelMaterialParameterData>& InOutParameterData) const
{
	...
	ENQUEUE_RENDER_COMMAND(UpdateTexture)([DebugName, SizeX, Data = ParameterData.Data, Resource](FRHICommandListImmediate& RHICmdList)
	{
...
#if WITH_EDITOR
void UMaterialExpressionGetVoxelMaterial_Texture1D::CompileVoxel(
	...
	TArray<int32>& Inputs)
{
	...
	Inputs.Add(Compiler.TextureParameter(Name, FVoxelTextureUtilities::GetDefaultTexture2D(), SAMPLERTYPE_Color));
...
UMaterialExpressionGetVoxelMaterial_Color::UMaterialExpressionGetVoxelMaterial_Color()
{
	Outputs.Reset();

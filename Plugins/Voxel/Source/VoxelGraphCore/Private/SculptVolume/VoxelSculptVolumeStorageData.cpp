...
FVoxelSculptVolumeStorageData::FVoxelSculptVolumeStorageData(const FName Name)
	: Name(Name)
	, Dependency(FVoxelDependency::Create(STATIC_FNAME("SculptVolume"), Name))
{
}

bool FVoxelSculptVolumeStorageData::HasChunks(const FVoxelBox& Bounds) const
{
...
void FVoxelSculptVolumeStorageData::SetDistances(
...
void FVoxelSculptVolumeStorageData::ClearData()
{
	VOXEL_FUNCTION_COUNTER();
...
void FVoxelSculptVolumeStorageData::Serialize(FArchive& Ar)
{
	VOXEL_FUNCTION_COUNTER();

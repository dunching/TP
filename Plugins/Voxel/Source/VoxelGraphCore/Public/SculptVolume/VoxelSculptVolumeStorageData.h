...
class VOXELGRAPHCORE_API FVoxelSculptVolumeStorageData : public TSharedFromThis<FVoxelSculptVolumeStorageData>
{
public:
...
public:
	...
	TSharedPtr<const TVoxelComputeValue<FVoxelSurface>> Compute_RequiresLock;

	explicit FVoxelSculptVolumeStorageData(FName Name);

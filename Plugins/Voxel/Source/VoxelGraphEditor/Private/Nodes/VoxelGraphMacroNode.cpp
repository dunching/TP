...
void UVoxelGraphMacroNode::AllocateDefaultPins()
{
	...
	for (const FVoxelGraphParameter& Parameter : Graph->Parameters)
	{
		...
		{
			CachedExposedPins.Add(GraphPin);
		}
...
{
	return CachedExposedPins.Contains(&Pin);
}
...
bool UVoxelGraphMacroNode::CanCreateUnderSpecifiedSchema(const UEdGraphSchema* Schema) const
{

...
VOXEL_RUN_ON_STARTUP_EDITOR(BindVoxelOnClearNodeStats)
{
	GVoxelOnClearNodeStats.AddLambda([]
	{
		VOXEL_SCOPE_COUNTER("OnClearNodeStats");

		ForEachObjectOfClass<UVoxelGraphNode>([](UVoxelGraphNode* Node)
		{
			Node->Stats = {};
		});
	});

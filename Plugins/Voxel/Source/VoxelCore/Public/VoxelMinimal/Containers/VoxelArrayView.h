...
FORCEINLINE auto MakeVoxelArrayView(T&& Other)
{
	...
	{
		return TVoxelArrayView<typename TRemoveReference<decltype(*GetData(DeclVal<T>()))>::Type>(Other);
	}
	else
	{
...
FORCEINLINE auto MakeVoxelArrayView(ElementType* Pointer, int32 Size)
{

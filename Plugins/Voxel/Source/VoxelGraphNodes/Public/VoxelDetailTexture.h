...
class VOXELGRAPHNODES_API UVoxelDetailTexture : public UObject
{
	GENERATED_BODY()
...
UCLASS()
class VOXELGRAPHNODES_API UVoxelFloatDetailTexture : public UVoxelDetailTexture
{
	GENERATED_BODY()
...
UCLASS()
class VOXELGRAPHNODES_API UVoxelColorDetailTexture : public UVoxelDetailTexture
{
	GENERATED_BODY()
...
UCLASS()
class VOXELGRAPHNODES_API UVoxelMaterialIdDetailTexture : public UVoxelDetailTexture
{
	GENERATED_BODY()
...
UCLASS()
class VOXELGRAPHNODES_API UVoxelNormalDetailTexture : public UVoxelDetailTexture
{
	GENERATED_BODY()
...
DECLARE_VOXEL_MEMORY_STAT(VOXELGRAPHNODES_API, STAT_VoxelDetailTextureMemory, "Voxel Detail Texture Memory (GPU)");
...
USTRUCT()
struct VOXELGRAPHNODES_API FVoxelDetailTextureDynamicMaterialParameter : public FVoxelDynamicMaterialParameter
{
	GENERATED_BODY()
...
class VOXELGRAPHNODES_API FVoxelDetailTextureAllocator : public TSharedFromThis<FVoxelDetailTextureAllocator>
{
public:
...
class VOXELGRAPHNODES_API FVoxelDetailTextureAllocation
...
class VOXELGRAPHNODES_API FVoxelDetailTextureUpload : public TSharedFromThis<FVoxelDetailTextureUpload>
{
public:
		...
		, BytesPerPixel(GPixelFormats[Allocation.PixelFormat].BlockBytes)
	{
		FVoxelUtilities::SetNumFast(
			UploadData,
			Allocation.Num * FMath::Square(Allocation.TextureSize) * BytesPerPixel);
	}
...
class VOXELGRAPHNODES_API FVoxelDetailTexturePool : public TSharedFromThis<FVoxelDetailTexturePool>
{
public:
...
class VOXELGRAPHNODES_API FVoxelDetailTextureManager
	: public FVoxelTicker
	, public FGCObject
{
public:
...
extern VOXELGRAPHNODES_API FVoxelDetailTextureManager* GVoxelDetailTextureManager;